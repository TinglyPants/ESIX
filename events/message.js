...
module.exports = {
	...
	async execute(interaction) {
		...
		if (interaction.author.id == spaghettiOs && mouseNumRand == 2){
            ...
            .setColor(0xc31e78)
            .setTitle("**Thank you for joining the ✨[MOUSE]✨ subscription service 💖🐁💖!**")
            .setDescription("We are here to ensure you get your *daily* recommended dose of ✨[MOUSE]✨!\n*Here is your* ✨[MOUSE]✨! 🐁🐁🐁 ")
            ...
            let message = new EmbedBuilder()
            .setColor(0xc31e78)
            .setTitle("**Thank you for joining the ✨[MOUSE]✨ subscription service 💖🖱️💖!**")
        ...
        if (interaction.author.id == a_m_i_n && furryNumRand == 0){
            ...
            .setDescription("Thank you for joining the 😳[Furry Women Lovers' Society]😳.\n💖 **Please remember to give us a ✨[5 STAR]✨ rating!** 💖\n*🥵 Enjoy!~*")
